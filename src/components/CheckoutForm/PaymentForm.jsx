    ...
    const handleSubmit = async (event, elements, stripe) => {
        ...
        if (error) {
            ...
            const orderData = {
                ...
                cusomer: { firstname: shippingData.firstName, lastname: shippingData.lastName, email: shippingData.email },
                shipping: {
                    name: 'Primary',
                ...
                fulfillment: { shiping_method: shippingData.shippingOption },
                payment: {
                    gateway: 'stripe',
                    stripe: {
